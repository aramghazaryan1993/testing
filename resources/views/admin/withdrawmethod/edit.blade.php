      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.withdraw.method.update',$data->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="inp-min" placeholder="{{  __('Minimum Amount') }}" name="min_amount" value="{{ $data->min_amount }}" required>
            </div>

            <div class="form-group">
              <label for="inp-max">{{  __('Maximum Amount')  }} </label>
              <input type="number" class="form-control" id="inp-max" placeholder="{{  __('Maximum Amount') }}" name="max_amount" value="{{ $data->max_amount }}" required>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="inp-fixed" placeholder="{{  __('Withdraw Fixed Fee') }}" name="fixed" step="0.1" value="{{ $data->fixed }}" required>
            </div>

            <div class="form-group">
              <label for="inp-percentage">{{  __('Withdraw Percentage Charge')  }} <small>({{__('Leave 0 if you don\'t want to add')}})</small></label>
              <input type="number" class="form-control" id="inp-percentage" placeholder="{{  __('Withdraw Percentage Charge') }}" step="0.1" name="percentage" value="{{ $data->percentage }}" required>
            </div>
