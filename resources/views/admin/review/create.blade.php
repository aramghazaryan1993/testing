...
<div class="card">
  <div class="d-sm-flex align-items-center justify-content-between py-3">
    <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Add New Review') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('admin.review.index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
  ...
  <div class="card mb-4 mt-3">
    ...
    <div class="card-body">
      ...
      <form class="geniusform" action="{{route('admin.review.store')}}" method="POST" enctype="multipart/form-data">
