...
<div class="card">
  ...
  <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Edit Partner') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('admin.partners.index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
  <ol class="breadcrumb">
  ...
  <div class="col-md-10">
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.partners.update',$data->id)}}" method="POST" enctype="multipart/form-data">
