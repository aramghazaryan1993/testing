  ...
  <div class="col-md-12">
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.social.links.update',$data->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="link" name="link"  placeholder="{{ __('Enter Link') }}" value="{{ $data->link }}" required>
            </div>
