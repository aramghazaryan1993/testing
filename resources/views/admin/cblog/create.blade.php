...
<div class="card">
	...
	<h5 class=" mb-0 text-gray-800 pl-3">{{ __('Add New Category') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('admin.cblog.index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
	<ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.cblog.create') }}">{{ __('Add New Category') }}</a></li>
	</ol>
	</div>
</div>
  ...
  <div class="col-md-10">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.cblog.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group ">
                ...
                <input type="color" name="colors"  required  class="form-control"  value="" id="exampleInputPassword1">
            </div>
