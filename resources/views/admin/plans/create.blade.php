      ...
      <div class="card-body py-5">
        ...
        <form class="geniusform" action="{{route('admin.plans.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group" id="fixedAmount">
              ...
              <input type="number" class="form-control" id="inp-fixed_amount" name="fixed_amount"  placeholder="{{ __('Fixed Amount') }}" value="">
            </div>
            ...
            <div class="row d-none" id="Range">
                <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="min_amount" name="min_amount" placeholder="{{ __('Minimum Amount') }}" min="1" value="">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="max_amount" name="max_amount" placeholder="{{ __('Maximum Amount') }}" min="1" value="">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="inp-percentage" name="profit_percentage"  placeholder="{{ __('Enter Return Percentage') }}" value="" required>
            </div>
            ...
            <div class="form-group">
              ...
              <select name="schedule_hour" class="form-control" id="schedule_hour">
                @foreach ($schedules as $key=>$data)
                  <option value="{{ $data->time }}" data-sechedule-id="{{ $data->id }}"> {{ $data->name }} </option>
                @endforeach
              </select>
            </div>
            ...
            <div class="form-group d-none" id="repeatable">
              <label for="inp-name">{{ __('Repeatable') }}</label>
              <div class="input-group mb-3">
                <input type="text" name="profit_repeat" class="form-control" placeholder="@lang('Repeatable')" aria-label="@lang('Repeatable')" aria-describedby="basic-addon2">
